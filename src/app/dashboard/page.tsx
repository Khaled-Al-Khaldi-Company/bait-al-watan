    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#f0f4f8', fontFamily: 'var(--font-outfit)', direction: 'rtl' }}>
      ...
      <main className="main-content-layout" style={{ flex: 1, padding: '2.5rem' }}>
        ...
        <header style={{ 
          ...
          <div>
            <h1 style={{ fontSize: '1.8rem', fontWeight: 800, color: '#1e293b' }}>مرحباً بك، مدير النظام 👋</h1>
          ...
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
             ...
             <div onClick={() => signOut()} style={{ cursor: 'pointer', width: '45px', height: '45px', borderRadius: '12px', background: '#fee2e2', color: '#dc2626', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s' }} title="تسجيل الخروج">
                <LogOut size={20} />
             </div>
      ...
      {(showAddModal && !isViewer) && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(6, 78, 59, 0.4)', backdropFilter: 'blur(10px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }}>
          <Card style={{ width: '100%', maxWidth: '500px', padding: '2.5rem', borderRadius: '32px', border: 'none', boxShadow: '0 40px 100px rgba(0,0,0,0.2)' }}>
